...
<html>
    <head>
        ...
        <script type="text/javascript">
            function fillForm(lockerNo, branchID, isAvailable) {
                document.getElementById('selectedLockerNo').value = lockerNo;
                document.getElementById('selectedBranchID').value = branchID;
                document.getElementById('selectedIsAvailable').value = isAvailable;
    ...
    <body>
        <div class="centered-container">
            ...
            <nav class="navbar">
                ...
                <a href="locker.php" class="active">Locker</a>
        ...
        <form method="POST" action="locker.php">
            <div class="form-row">
                <label class="form-label">LockerNo:</label>
                <input type="number" id="selectedLockerNo" name="selectedLockerNo" class="form-input">
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <select id="selectedIsAvailable" name="selectedIsAvailable" class="form-input">
        ...
        <hr />
        <h2 style="margin-left: 20px">Table - Locker</h2>
        <?php
        ...
        function displayLockers() {
            ...
            $result = executePlainSQL("SELECT * FROM Locker");
            echo "<table border='1' style='margin-left: 20px'>";
            echo "<tr><th>LockerNo</th><th>BranchID</th><th>IsAvailable</th></tr>";
        
            while ($row = oci_fetch_array($result, OCI_BOTH)) {
                echo "<tr onclick='fillForm(\"" . $row["LOCKERNO"] . "\", \"" . $row["BRANCHID"] . "\", \"" . $row["ISAVAILABLE"] . "\")'>";
                echo "<td>" . $row["LOCKERNO"] . "</td>";
            ...
            echo "</table>";
            echo "<p style='margin-left: 20px'>Click the locker that you want to edit.</p>";
        }        
