    ...
    <body>
        <div class="centered-container">
            ...
            <nav class="navbar">
                ...
                <a href="regularmemberbranches.php" class="active">RegularMemberBranches</a>
        ...
        <form method="POST" action="regularmemberbranches.php">
        <div class="form-row">
        ...
        <hr />
        <h2 style="margin-left: 20px">Table - RegularMemberBranches</h2>
        <?php
        ...
        function displayRegularMemberBranches() {
            global $db_conn;

            $result = executePlainSQL("SELECT * FROM RegularMemberBranches");
