...
<html>
    <head>
        ...
        <script type="text/javascript">
            function fillForm(passID, memberID, startDate, endDate) {
                document.getElementById('selectedPassID').value = passID;
    ...
    <body>
        <div class="centered-container">
            ...
            <nav class="navbar">
                ...
                <a href="guestpass.php"  class="active">GuestPass</a>
        ...
        <form method="POST" action="guestpass.php">
            <div class="form-row">
                <label class="form-label">PassID:</label>
                <input type="number" id="selectedPassID" name="selectedPassID" class="form-input">
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <input type="text" id="selectedEndDate" name="selectedEndDate" class="form-input">
            </div>
        </form>
        <hr />
        <h2 style="margin-left: 20px">Table - GuestPass</h2>
        <?php
        ...
        function displayGuestPass() {
            global $db_conn;
        
            $result = executePlainSQL("SELECT * FROM GuestPass");
            echo "<table border='1' style='margin-left: 20px'>";
            echo "<tr><th>PassID</th><th>MemberID</th><th>Start Date</th><th>End Date</th></tr>";
        
            while ($row = oci_fetch_array($result, OCI_BOTH)) {
                echo "<tr onclick='fillForm(\"" . $row["PASSID"] . "\", \"" . $row["MEMBERID"] . "\", \"" . $row["STARTDATE"] . "\", \"" . $row["ENDDATE"] . "\")'>";
            ...
            echo "</table>";
            echo "<p style='margin-left: 20px'>Click the guestpass that you want to edit.</p>";
        }
